...
public class HttpConnection {
	private static final String SEED = "hehedesk01020304";
	/** 
     * 向指定URL发送GET方法的请求 
     * @param url 发送请求的URL 
	...
	public  String get(String url) throws Exception {
		...
		in.close();
//		if(result!=null){
//			result = AESEncryptor.decrypt(SEED, result);
//        }
		return result;
	}
	/**  
...
//		if(res!=null){
//			res = AESEncryptor.decrypt(SEED, res);
//        }
		return res;
	}
	public synchronized static String GetContent(String u){
		byte[] bs = null;
		try {
			URL url = new URL(u);
		...
		String result = null;
		if(bs != null) result = new String(bs);
