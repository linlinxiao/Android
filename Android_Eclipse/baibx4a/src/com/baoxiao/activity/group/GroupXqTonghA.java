...
public class GroupXqTonghA extends Activity implements OnClickListener,OnItemSelectedListener
{
	...
	public void onClick(View view)
	{
		...
		case R.id.xqBtnOk:
			...
			if(p>0){
				...
				Intent intent3 = new Intent(GroupXqTonghA.this,GroupMyTonghA.class);
		...
		case R.id.xqBtnNo:
			Intent intent2 = new Intent(GroupXqTonghA.this,GroupMyTonghA.class);
		...
		case R.id.delGroup:
			...
			int d = GroupService.deleteGroup(user.getId().toString(),user.getPhoneid(), this,userId);
			if(d>0){
				...
				Intent intent = new Intent(GroupXqTonghA.this,GroupMyTonghA.class);
				overridePendingTransition(R.anim.right_in, R.anim.right_out);
	...
	public boolean onKeyDown(int keyCode, KeyEvent event)
	{
		...
		if(keyCode == KeyEvent.KEYCODE_BACK){
			Intent intent4 = new Intent(GroupXqTonghA.this,GroupMyTonghA.class);
