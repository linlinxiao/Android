...
public class XinLiShowA extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState){
		...
		url = Define.Server + "xinliShow.action?" + data;
		webView.loadUrl(url);
		...
		webView.setWebViewClient(new WebViewClient(){
			public boolean shouldOverrideUrlLoading(WebView view, String url)
            {
	    		...
	    		startActivity(new Intent(XinLiShowA.this,WebShowA2.class)
	    				.putExtra("url", url));
				return true;
            }
			@Override
	...
	public void share(View v) {
		UMImage image = new UMImage(XinLiShowA.this,R.drawable.product_xinli);
//		String age = getAge("age");
		...
		ShareService.startShareWithImage(image,url,"您好！我是" + name + ",这是我为您设计的鑫利保障计划，请您查看！",
				XinLiShowA.this,"鑫利计划书");
	}
