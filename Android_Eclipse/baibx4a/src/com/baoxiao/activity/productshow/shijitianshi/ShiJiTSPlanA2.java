...
public class ShiJiTSPlanA2 extends Activity{
...
//	 private String[] age0_17;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.ps_shijits_plan2);
...
//		sp_age.setOnItemSelectedListener(itemSelectedListener);
		...
		sp_period.setOnItemSelectedListener(new OnItemSelectedListener() {
			...
			public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
				...
				ArrayAdapter<CharSequence> adapter0 = 
						ArrayAdapter.createFromResource(ShiJiTSPlanA2.this,array_id,R.layout.children_spinner); 
				adapter0.setDropDownViewResource(android.R.layout.select_dialog_singlechoice);
...
//		});
    ...
    public void sjtsh_submit(View v){
    	String data = getData();
    	startActivity(new Intent(this,ShiJiTSShowA2.class)
    			.putExtra("data", data));
    }
