...
public class ShouHuXTiaoKuanA extends Activity implements OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.ps_shouhux_tiaokuan);
	...
	public void onClick(View v) {
		...
		case R.id.shouHuX:
			...
			Bundle b = new Bundle();
			b.putInt("maxPageCount", 10);
			b.putString("url", "product/shouhux/yanshi/tiaokuan/shx");
		...
		case R.id.shaoEr:
			...
			b2.putString("url", "product/shouhux/yanshi/tiaokuan/serzj");
		...
		case R.id.huoMianZhongJi:
			...
			b3.putString("url", "product/shouhux/yanshi/tiaokuan/serhmzj");
