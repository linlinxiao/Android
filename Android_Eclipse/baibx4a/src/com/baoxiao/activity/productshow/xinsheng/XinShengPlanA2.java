...
public class XinShengPlanA2 extends Activity{
...
//	 cb_enjoy_health_hospital,//健享人生住院医疗保险
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.ps_xinsheng_plan2);
...
//		cb_add_hospital_stay = (CheckBox)findViewById(R.id.cb_add_hospital_stay);
...
//				 R.layout.children_spinner, age0_17);
		...
		sp_age.setOnItemSelectedListener(new OnItemSelectedListener() {
			...
			public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
				String array[] = new String[]{"10","15","20","30"};
				if (position > 45) {
					array = new String[]{"10","15","20"};
				}
				ArrayAdapter<String> adapter = new ArrayAdapter<String>(XinShengPlanA2.this,R.layout.children_spinner, array);
...
//						if (position < 46) {
//							array_id = R.array.age18_55;
//						}
//						ArrayAdapter<CharSequence> adapter0 = 
//								ArrayAdapter.createFromResource(XinShengPlanA2.this,array_id,R.layout.children_spinner); 
//						adapter0.setDropDownViewResource(android.R.layout.select_dialog_singlechoice);
...
//				});
		...
		int array_id = R.array.age18_60;
		adapter0 = ArrayAdapter.createFromResource(XinShengPlanA2.this,array_id,R.layout.children_spinner); 
		adapter0.setDropDownViewResource(android.R.layout.select_dialog_singlechoice);
		sp_privy_age.setAdapter(adapter0);
...
//		});
    ...
    public void sjtsh_submit(View v){
    	String data = getData();
    	startActivity(new Intent(this,XinShengShowA2.class)
    			.putExtra("data", data));
    }
	private String getData(){
		...
		String accident_injury_safe = et_accident_injury_safe.getText().toString();//意外伤害医疗
