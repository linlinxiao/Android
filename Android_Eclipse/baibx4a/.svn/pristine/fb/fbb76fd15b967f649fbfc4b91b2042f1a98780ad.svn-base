...
public class PingAnFuShowA2 extends Activity {
...
//		webSettings.setJavaScriptEnabled(true);
		...
		home_url = Define.Server + "peaceShow.action?" + data;
		url = home_url;
		...
		webView.setWebViewClient(new WebViewClient(){
            ...
            { //  重写此方法表明点击网页里面的链接还是在当前的webview里跳转，不跳到浏览器那边
	           ...
	           int imageId = -1;
	           startActivity(new Intent(PingAnFuShowA2.this,WebShowA2.class)
	    				.putExtra("url", url)
	...
	public void share(View v) {
		if (url.contains(Define.Server + "peaceShow.action?")) {
			UMImage image = new UMImage(PingAnFuShowA2.this,R.drawable.peace_share_icon);
...
//		    String name = getSharedPreferences("mycard", Activity.MODE_PRIVATE).getString("p1t1", null);
			...
			ShareService.startShareWithImage(image,url,content,PingAnFuShowA2.this,"平安福计划书");
		}
	}
...
//	    http://www.rabbitpre.com/m/MIBIBYBAn
	    ...
	    view.findViewById(R.id.ll_peace_pop_item1).setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
	    		...
	    		startActivity(new Intent(PingAnFuShowA2.this,WebShowA.class)
	    				.putExtra("url", url)
	    				.putExtra("shareName", shareName)
