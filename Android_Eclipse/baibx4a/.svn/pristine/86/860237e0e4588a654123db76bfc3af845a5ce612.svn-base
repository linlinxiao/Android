...
public class ChildrenPingAnFuTiaoKuanA extends Activity implements OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.ps_pinganfu_tiaokuan);
	...
	public void onClick(View v) {
		...
		case R.id.shouHuX:
			...
			Bundle b = new Bundle();
			b.putInt("maxPageCount", 7);
			b.putString("url", "product/pinganfu/yanshi/tiaokuan/pafzx");
		...
		case R.id.shaoEr:
			...
			b2.putString("url", "product/pinganfu/yanshi/tiaokuan/pafzj");
		...
		case R.id.huoMianZhongJi:
			...
			b3.putString("url", "product/pinganfu/yanshi/tiaokuan/zjhm");
		...
		case R.id.changQiYiWai:
			...
			b4.putString("url", "product/pinganfu/yanshi/tiaokuan/cqyw");
