 ...
 *
 */
public class ZhaopinWeb extends Activity implements OnClickListener
{
...
//		url = "http://192.168.0.211:8080/invation_m/invation_show.jsp";
...
//			System.out.println(id);
		...
		case R.id.share:
			...
			UMImage image = new UMImage(ZhaopinWeb.this, title_image_url);
			ShareService.startShareWithImage(image,url,title_name, 
					ZhaopinWeb.this,"");
			break;
		default:
			break;
	...
	private Handler handler = new Handler()
	{
		public void handleMessage(Message msg)
		{
			...
			cs.getJsonList(load,ZhaopinWeb.this,m);
		};
	};
