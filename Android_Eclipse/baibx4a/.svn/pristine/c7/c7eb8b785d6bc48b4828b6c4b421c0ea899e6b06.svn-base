...
public class GroupMyTonghA extends Activity implements OnItemClickListener,OnClickListener
{
	...
	public void onClick(View view)
	{
		...
		case R.id.yaoyue:
			Intent intent2 = new Intent(GroupMyTonghA.this, InvitationA.class);
